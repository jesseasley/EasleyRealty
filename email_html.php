    ...
    <div class="form-group col-lg-10">
        <div class="form-group">
            <div id="nameGroup">
                ...
                <div class="row">
                    <div id="nameParent" class="col-lg-12 has-error">
                        <input type="text" id="nameText" class="form-control" placeholder="Tell us your name" 
                               onchange="checkValid('name');" value="" />
            ...
            <div id="emailGroup">
                ...
                <div class="row">
                    <div id="emailParent" class="col-lg-12 has-error">
                        <input type="email" id="emailText" class="form-control" placeholder="yourname@domain.com" 
                               onchange="checkValid('email');" value="" />
            ...
            <div id="phoneGroup">
                ...
                <div class="row">
                    <div id="phoneParent" class="col-lg-12 has-error">
                        <input type="tel" id="phoneText" class="form-control" placeholder="Phone number " 
                               onchange="checkValid('phone');" value="" />
            ...
            <div id="subjectGroup">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <input type="text" id="subjectText" class="form-control" 
                               placeholder="You can specify a subject line for the email" value="" />
                    </div>
                </div>
            </div>
            <div id="bodyGroup">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <textarea rows="5" id="bodyTextArea" class="form-control" 
