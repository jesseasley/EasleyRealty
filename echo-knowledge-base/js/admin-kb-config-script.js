...

    {
        ...
        function epkb_update_preview_on_change() {
            ...
            $.ajax({
                ...
                {
                    $('#epkb-ajax-in-progress').text('Updating page preview ...').dialog('open');
                }
...

    {
        ...
        function epkb_ajax_main_page_config_change_request( target_type, target_name ) {
            ...
            $.ajax({
                ...
                beforeSend: function (xhr)
                {
                    $('#epkb-ajax-in-progress').text('Switching ' + target_type + ' ...').dialog('open');
                }
            }).done(function (response)
            {
                response = ( response ? response : '' );
...

    {
        ...
        function epkb_process_user_sequence_change( page, new_sequence ) {
            ...
            $.ajax({
                ...
                beforeSend: function (xhr)
                {
                    $('#epkb-ajax-in-progress').text('Switching article sequence ...').dialog('open');
                }
            }).done(function (response)
            {
                response = ( response ? response : '' );
