...
class EPKB_Welcome_Screen {
	...
	private function show_what_is_new() {   ?>
		...
		<div class="row">
			<div class="col-12">
				<h4>3.3.0, Feb 27, 2018</h4>
				<ul>
					<li>New: KB Templates: added template and styles for Category Archive page</li>
	...
	private function show_getting_started() {
		...
		$button1 = array( 'View Demo KB', admin_url( $this->configuration_url . '&epkb-demo=yes') );
		...
		$button1 = array( 'Configure KB', admin_url( $this->configuration_url . '&ekb-main-page=yes') );
		$button2 = array();
