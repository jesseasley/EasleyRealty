...
var propertyData = '({"properties": [' +
    '{"current":"0", "premier":"0", "address":"2639 Creekside Way<br>Highland Village", ' +
    '"caption":"Highland Shores", "image":"http://www.easleyrealty.com/images/2639CreeksideComingSoon.jpg", ' +
    '"description":"One of kind with no detail overlooked! Exquisite high-end fixtures and rich designer colors accenting every room. The kitchen is the centerpiece of any gathering w limestone walls, commercial grade appl, custom cabinets & large granite island. Resort-style master bath w travertine flooring, granite counters. Step into the backyard and find a relaxing spot under the many tress and lush landscaping oasis. Excellent location with shopping and main roads nearby. The community offers a lot for a little with pools, tennis courts, a community center and walking trails throughout."}' +
    '{"current":"0", "premier":"0", "address":"4401 Chicory<br>Denton", ' +
    '"caption":"Custom New Build", "image":"http://www.easleyrealty.com/images/4401Chicory.jpg", ' +
    '"description":"Custom new build from D.R. Horton in the Ryan Meadows subdivision.  1736 square feet with three bedrooms and two baths.  This house features an open floowplan, custom flooring, granite and large front and back porches."}' +
