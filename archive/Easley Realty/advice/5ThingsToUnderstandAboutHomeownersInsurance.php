...
<span class=pageheading>5 Things to Understand About Homeowners Insurance</SPAN><br><br>

<ol class="text">
<li>Look for
exclusions to coverage. For example,
...
<li>Look for
dollar limitations on claims. Even if
...
items are insured separately.</li>
...
<li>Understand
actual cash value. If you choose not
to replace your home when it's destroyed, you'll receive replacement cost, less
depreciation. This is called actual cash value.</li>
...
sufficient if you have significant assets.</li>
</ol>
