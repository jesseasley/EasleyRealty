...
$html ="<div id='" . str_replace(" ", "", $city) . "Carousel' class='carousel slide carousel-fade col-lg-12 col-md-12 col-sm-12 col-xs-12' data-ride='carousel' data-interval='5000'>";
...
//echo $url . "<br>";
    ...
    for ($i = 0; $i < $l; $i++) {
	    ...
	    if (strlen($listing) > 0){
            ...
            //create the table structure that's sent in the result call
            if (($i == 0) && ($j == 0))
